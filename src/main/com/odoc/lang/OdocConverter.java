 ...
 */
public class OdocConverter extends ORDocConverter {
    private static final Logger LOG = OdocLogger.getInstance();
    private final OdocLexer myLexer = new OdocLexer();

    @NotNull
    public HtmlBuilder convert(@NotNull String text) {
        ...
        try {
            ...
            while (tokenType != null) {
                ...
                if (currentBuilder instanceof ORDocSectionsBuilder && tokenType == OdocTypes.COMMENT_END) {
