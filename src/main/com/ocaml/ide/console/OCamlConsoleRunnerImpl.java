...
public class OCamlConsoleRunnerImpl extends AbstractConsoleRunnerWithHistory<OCamlConsoleView> implements OCamlConsoleRunner {
    ...
    public OCamlConsoleRunnerImpl(@NotNull Project project, @NotNull ToolWindow window) {
        ...
        try {
            ...
            ProgressManager.getInstance().run(new Task.Backgroundable(getProject(),
                ...
                @Override public void run(@NotNull ProgressIndicator indicator) {
                    ...
                    OCamlConsoleView consoleView = OCamlConsoleRunnerImpl.this.getConsoleView();
                    consoleView.setup();
                }
            });
        } catch (Exception e) {
    ...
    @Override public boolean isVariableViewEnabled() {
