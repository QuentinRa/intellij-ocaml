...
public class SdkEditor implements Configurable, Place.Navigator {
    ...
    public String getDisplayName() {
        return OCamlBundle.message("sdk.configure.editor.title");
    }
    ...
    private @NotNull String getHomeFieldLabelValue() {
    ...
    private void doSelectHomePath() {
        ...
        SdkPopupFactory
                ...
                .withSdkFilter(sdk -> {
                    ...
                    return !FileUtil.pathsEqual(sdk.getHomePath(), mySdk.getHomePath());
                })
                .onSdkSelected(sdk -> {
    ...
    private class EditedSdkModificator implements SdkModificator {
        ...
        @Override
        public @NotNull VirtualFile[] getRoots(@NotNull OrderRootType rootType) {
