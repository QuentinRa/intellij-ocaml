...
public class OCamlClassSpecImpl extends ASTWrapperPsiElement implements OCamlClassSpec {

  public OCamlClassSpecImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public OCamlClassType getClassType() {
    return findNotNullChildByClass(OCamlClassType.class);
  }
