...
class DuneHighlightingAnnotator : Annotator {
    override fun annotate(element: PsiElement, holder: AnnotationHolder) {
        ...
        if (elementType != DuneTypes.ATOM_VALUE_ID && elementType != DuneTypes.ATOM_VALUE_COMPLEX) return
        ...
        val color = if (element.parent.parent?.parent?.prevSibling?.elementType == DuneTypes.LPAREN)
                if (element.parent.parent?.parent?.parent?.parent is PsiFile) DuneColor.INSTRUCTION
