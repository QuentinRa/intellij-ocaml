...
public final class VersionOnlyRegexTest extends OCamlBaseTest {

    private void assertIsUnknownVersion(String path) {
        assertTrue(OCamlSdkVersionManager.isUnknownVersion(OCamlSdkVersionManager.parseWithoutModifier(path)));
    }

    private void assertIsVersion(String path, String expectedVersion) {
        assertEquals(expectedVersion, OCamlSdkVersionManager.parseWithoutModifier(path));
